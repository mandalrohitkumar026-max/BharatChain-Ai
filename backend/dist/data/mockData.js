...
export const mockSuppliers = [
    ...
    ...Array.from({ length: 42 }).map((_, idx) => {
        ...
        return {
            ...
            financialRisk: (score > 70 ? 'High' : score > 45 ? 'Medium' : 'Low'),
            logisticsRisk: (score > 65 ? 'High' : score > 40 ? 'Medium' : 'Low'),
            ...
            coordinates: [countryObj.lat + (idx % 5) * 0.5, countryObj.lng + (idx % 5) * 0.5]
        };
    })
];
// ==========================================
...
export const mockFactories = [
    ...
    ...Array.from({ length: 14 }).map((_, idx) => {
        ...
        return {
            ...
            status: (idx % 5 === 0 ? 'At Risk' : 'Operational'),
...
export const mockProducts = [
    ...
    ...Array.from({ length: 25 }).map((_, idx) => {
        ...
        return {
            ...
            status: (isAtRisk ? 'At Risk' : 'Normal'),
...
// 6. PORT CONGESTIONS
// ==========================================
export const mockPortCongestions = [
    {
        id: 'prt-01',
...
// ==========================================
export const mockAlternativeComparisons = [
    {
        id: 'alt-cmp-01',
        componentId: 'cmp-01',
        componentName: 'Power Controller 800V GaN',
